...
DEFAULT_CONFIG = {
    ...
    "language": "fa",
    "welcome_message": "welcome {username} to my room",
    "announcement_interval": 300,
    "announcement_message": "برای اجاره بات به آیدی @njix پیام دهید!"
}
    ...
    async def on_chat(self, user: User, message: str):
        ...
        try:
            ...
            if msg_lower in self.emotes:
                ...
                await self.highrise.chat("👑 سازنده این بات: @njix 👑")
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "6a5d44907c28a61ea71873fb")
    api_token = os.getenv("API_TOKEN", "620e19979728244b9a8e6fe4bbe6fc977669a48ee919178cd928ccc0b7b9207f")
